// ⚠️ COPIA COMPARTIDA — Este archivo debe mantenerse idéntico a:
// LlegoiOS/models/DeliveryActivityAttributes.swift
// Ambos targets (app + widget) necesitan compilar este modelo.
