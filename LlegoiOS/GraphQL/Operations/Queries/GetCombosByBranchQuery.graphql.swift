...
public extension LlegoAPI {
  struct GetCombosByBranchQuery: GraphQLQuery {
    ...
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query GetCombosByBranch($branchId: String!, $availableOnly: Boolean! = true) { combosByBranch(branchId: $branchId, availableOnly: $availableOnly) { __typename id branchId name description imageUrl currency availability discountType discountValue basePrice finalPrice savings representativeProducts { __typename id name imageUrl } slots { __typename id name description minSelections maxSelections isRequired displayOrder options { __typename productId isDefault priceAdjustment product { __typename id name imageUrl price currency } availableModifiers { __typename name priceAdjustment } } } branch { __typename id name avatarUrl } createdAt } }"#
      ))
