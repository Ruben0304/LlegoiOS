...
public extension LlegoAPI {
  struct GetCombosByBranchQuery: GraphQLQuery {
    public static let operationName: String = "GetCombosByBranch"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query GetCombosByBranch($branchId: String!, $availableOnly: Boolean! = true) { combosByBranch(branchId: $branchId, availableOnly: $availableOnly) { __typename id branchId name description imageUrl currency availability discountType discountValue finalPrice savings startingFinalPrice startingSavings representativeProducts { __typename id name imageUrl } slots { __typename id name description minSelections maxSelections isFree displayOrder options { __typename productId isDefault priceAdjustment product { __typename id name imageUrl price currency } availableModifiers { __typename name priceAdjustment } } } giftOptions { __typename productId product { __typename id name imageUrl } } branch { __typename id name avatarUrl } createdAt } }"#
      ))
    ...
    public struct Data: LlegoAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
        .field("combosByBranch", [CombosByBranch].self, arguments: [
          "branchId": .variable("branchId"),
          "availableOnly": .variable("availableOnly")
        ]),
      ] }
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetCombosByBranchQuery.Data.self
      ] }

      /// Obtener todos los combos de una sucursal
      public var combosByBranch: [CombosByBranch] { __data["combosByBranch"] }

      /// CombosByBranch
      ///
      /// Parent Type: `ComboType`
      public struct CombosByBranch: LlegoAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GetCombosByBranchQuery.Data.CombosByBranch.self
        ] }
        ...
        /// CombosByBranch.RepresentativeProduct
        ///
        ...
        public struct RepresentativeProduct: LlegoAPI.SelectionSet {
          ...
          @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GetCombosByBranchQuery.Data.CombosByBranch.RepresentativeProduct.self
          ] }
        ...
        public struct Slot: LlegoAPI.SelectionSet {
          ...
          @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GetCombosByBranchQuery.Data.CombosByBranch.Slot.self
          ] }
          ...
          public struct Option: LlegoAPI.SelectionSet {
            ...
            @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GetCombosByBranchQuery.Data.CombosByBranch.Slot.Option.self
            ] }
            ...
            /// CombosByBranch.Slot.Option.Product
            ///
            /// Parent Type: `ProductType`
            public struct Product: LlegoAPI.SelectionSet {
              ...
              @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                GetCombosByBranchQuery.Data.CombosByBranch.Slot.Option.Product.self
              ] }
            ...
            /// CombosByBranch.Slot.Option.AvailableModifier
            ///
            ...
            public struct AvailableModifier: LlegoAPI.SelectionSet {
              ...
              @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                GetCombosByBranchQuery.Data.CombosByBranch.Slot.Option.AvailableModifier.self
              ] }
        ...
        public struct GiftOption: LlegoAPI.SelectionSet {
          ...
          @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GetCombosByBranchQuery.Data.CombosByBranch.GiftOption.self
          ] }
          ...
          /// CombosByBranch.GiftOption.Product
          ///
          /// Parent Type: `ProductType`
          public struct Product: LlegoAPI.SelectionSet {
            @_spi(Unsafe) public let __data: DataDict
            ...
            @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              GetCombosByBranchQuery.Data.CombosByBranch.GiftOption.Product.self
            ] }
        ...
        public struct Branch: LlegoAPI.SelectionSet {
          ...
          @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GetCombosByBranchQuery.Data.CombosByBranch.Branch.self
          ] }
