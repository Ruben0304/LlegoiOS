...
public extension LlegoAPI {
  struct GetSimilarBranchesQuery: GraphQLQuery {
    public static let operationName: String = "GetSimilarBranches"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query GetSimilarBranches($branchId: String!, $limit: Int, $jwt: String) { getSimilarBranches(branchId: $branchId, limit: $limit, jwt: $jwt) { __typename id businessId name address avatarUrl avatarUrlBaja avatarUrlAlta coverUrl coverUrlBaja coverUrlAlta deliveryRadius catalogOnly createdAt products(limit: 2, availableOnly: false) { __typename id name price currency imageUrlBaja } } }"#
      ))
    ...
    public struct Data: LlegoAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
        .field("getSimilarBranches", [GetSimilarBranch].self, arguments: [
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        GetSimilarBranchesQuery.Data.self
      ] }

      /// Sucursales similares a la dada usando Qdrant recommend
      public var getSimilarBranches: [GetSimilarBranch] { __data["getSimilarBranches"] }

      /// GetSimilarBranch
      ///
      /// Parent Type: `BranchType`
      public struct GetSimilarBranch: LlegoAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          GetSimilarBranchesQuery.Data.GetSimilarBranch.self
        ] }
        ...
        public struct Product: LlegoAPI.SelectionSet {
          ...
          @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            GetSimilarBranchesQuery.Data.GetSimilarBranch.Product.self
          ] }
