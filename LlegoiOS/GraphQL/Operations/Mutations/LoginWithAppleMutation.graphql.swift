...
public extension LlegoAPI {
  struct LoginWithAppleMutation: GraphQLMutation {
    public static let operationName: String = "LoginWithApple"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation LoginWithApple($input: AppleLoginInput!) { loginWithApple(input: $input) { __typename accessToken tokenType user { __typename id name email phone role createdAt } } }"#
      ))

    public var input: AppleLoginInput

    public init(input: AppleLoginInput) {
      self.input = input
    }
    ...
    public struct Data: LlegoAPI.SelectionSet {
      ...
      public struct LoginWithApple: LlegoAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
