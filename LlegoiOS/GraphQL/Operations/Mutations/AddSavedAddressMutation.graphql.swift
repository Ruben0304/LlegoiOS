...
public extension LlegoAPI {
  struct AddSavedAddressMutation: GraphQLMutation {
    public static let operationName: String = "AddSavedAddress"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation AddSavedAddress($input: SavedAddressInput!, $jwt: String!) { addSavedAddress(input: $input, jwt: $jwt) { __typename id savedAddresses { __typename id label street city reference addressType buildingName floor apartment deliveryInstructions latitude longitude } defaultAddressId } }"#
      ))

    public var input: SavedAddressInput
    ...
    public struct Data: LlegoAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
        .field("addSavedAddress", AddSavedAddress.self, arguments: [
          "input": .variable("input"),
          "jwt": .variable("jwt")
        ]),
      ] }
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        AddSavedAddressMutation.Data.self
      ] }

      /// Guardar una nueva dirección de entrega en el perfil
      public var addSavedAddress: AddSavedAddress { __data["addSavedAddress"] }

      /// AddSavedAddress
      ///
      /// Parent Type: `UserType`
      public struct AddSavedAddress: LlegoAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          AddSavedAddressMutation.Data.AddSavedAddress.self
        ] }
        ...
        public struct SavedAddress: LlegoAPI.SelectionSet {
          ...
          @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            AddSavedAddressMutation.Data.AddSavedAddress.SavedAddress.self
          ] }
