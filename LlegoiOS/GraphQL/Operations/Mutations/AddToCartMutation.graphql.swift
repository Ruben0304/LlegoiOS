...
public extension LlegoAPI {
  struct AddToCartMutation: GraphQLMutation {
    public static let operationName: String = "AddToCart"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation AddToCart($productId: String!, $jwt: String) { addToCart(productId: $productId, jwt: $jwt) { __typename id userId productId type createdAt } }"#
      ))
    ...
    public struct Data: LlegoAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
        .field("addToCart", AddToCart?.self, arguments: [
          "productId": .variable("productId"),
          "jwt": .variable("jwt")
        ]),
      ] }
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        AddToCartMutation.Data.self
      ] }
      ...
      public struct AddToCart: LlegoAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          AddToCartMutation.Data.AddToCart.self
        ] }
