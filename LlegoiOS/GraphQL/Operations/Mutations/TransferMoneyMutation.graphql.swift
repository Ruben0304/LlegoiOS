...
public extension LlegoAPI {
  struct TransferMoneyMutation: GraphQLMutation {
    public static let operationName: String = "TransferMoney"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation TransferMoney($jwt: String!, $input: TransferInput!) { transferMoney(jwt: $jwt, input: $input) { __typename id fromOwnerId fromOwnerType toOwnerId toOwnerType amount currency type status description createdAt completedAt } }"#
      ))

    public var jwt: String
    public var input: TransferInput
    ...
    public struct Data: LlegoAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
        .field("transferMoney", TransferMoney.self, arguments: [
          "jwt": .variable("jwt"),
          "input": .variable("input")
        ]),
      ] }
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        TransferMoneyMutation.Data.self
      ] }

      /// Transferir dinero a otro usuario o sucursal
      public var transferMoney: TransferMoney { __data["transferMoney"] }

      /// TransferMoney
      ///
      /// Parent Type: `WalletTransactionType`
      public struct TransferMoney: LlegoAPI.SelectionSet {
        @_spi(Unsafe) public let __data: DataDict
        @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          TransferMoneyMutation.Data.TransferMoney.self
        ] }
